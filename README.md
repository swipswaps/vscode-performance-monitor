# ⚙️ Vscode Performance Monitor

⚙️ **Real-time VSCode CPU spike detection and analysis**
...
├── scripts/
│   ├── vscode_cpu_spike_monitor.py    # Core functionality
├── docs/                              # Documentation
└── README.md                          # This file
```
...
git clone https://github.com/swipswaps/vscode-performance-monitor.git
cd vscode-performance-monitor
